...
abstract class _AppConfigurationStore with Store {
  ...
  // Add these to your _AppConfigurationStore abstract class

  @observable
  bool facebookLoginStatus = getBoolAsync(FACEBOOK_LOGIN_STATUS);

  @action
  Future<void> setFacebookLoginStatus(bool val) async {
    facebookLoginStatus = val;
    await setValue(FACEBOOK_LOGIN_STATUS, val);
  }
