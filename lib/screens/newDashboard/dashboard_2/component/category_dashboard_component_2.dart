...
class CategoryDashboardComponent2 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Always use grid item sizing for consistency
    ...
    final double rectangleWidth = context.width() / 4 - 10;
        ...
        children: [
              ...
              Padding(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: isSelected ? primaryColor : orangeColor,
          ...
          Container(
            ...
            child: Text(
              ...
              style: boldTextStyle(
                  size: 12, color: isSelected ? primaryColor : null),
